...
from get_data import OrdemDeProducao
...
class Label(Canvas):
    ...
    def __init__(self, op: OrdemDeProducao) -> None:
        super().__init__("label.pdf", LABEL_SIZE)
        self.op = op
    ...
    def generate_label(self):
        elements_positions = {
            "date": {"x": MARGIN, "y": 215, "text": self.op.today, "font": "FiraCodeRegular", "font_size": 12},
            ...
            "quantity": {"x": MARGIN, "y": 20, "text": f"QUANTIDADE: {self.op.quantity}", "font": "FiraCodeRegular", "font_size": 12},
            "quantity_barcode" : {"x": 150, "y": 15, "text": self.op.quantity, "font": "FiraCodeRegular", "font_size": 12},
...
if __name__ == "__main__":
    op = OrdemDeProducao(223536, "CEA085 000 000", "CEABS SERVIÇOS ELETRONICOS LTDA", "MODULO ISCA 2GKF TESTADOR CONTROLE MWM <br/>RAPIDO 20040 OEOEOE030 adfadwadawdawdawdaw", "CEA085 000 000 (225664)", 2000, 2, 10.50)
    lb = Label(op)
    lb.generate_label()